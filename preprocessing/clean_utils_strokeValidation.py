...
def clean_case():
    ...
    df_case.loc[out_of_range(df_case['IVTPATH_ID'], ['1', '2']), 'IVTPATH_ID'] = np.nan
    df_case.loc[out_of_range(df_case['OFFD_ID'], ['1', '2', '99']), 'OFFD_ID'] = np.nan
    df_case.loc[out_of_range(df_case['ECG_ID'], ['0', '1']), 'ECG_ID'] = np.nan
    df_case.loc[out_of_range(df_case['OMAD_ID'], ['0', '1', '2', '3', '4', '5', '6']), 'OMAD_ID'] = np.nan
